  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Password", style: TextStyle(color: Colors.black, fontFamily: "Montserrat", fontSize: 22, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text("Old Password", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Montserrat")),
                    ...
                    const SizedBox(height: 20),
                    const Text("New Password", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Montserrat")),
                    const SizedBox(height: 20),
                    SizedBox(
                      height: 35,
                      child: TextFormField(
                    ...
                    const SizedBox(height: 20),
                    const Text("Confirm Password", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Montserrat")),
                    const SizedBox(height: 20),
                    SizedBox(
                      height: 35,
                      child: TextFormField(
