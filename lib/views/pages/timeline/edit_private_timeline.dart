...
class EditPrivateTimeLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0.00,
        title: const Text("Edit Timeline", style: TextStyle(color: Colors.black, fontFamily: "Montserrat", fontSize: 22, fontWeight: FontWeight.bold)),
        centerTitle: true,
        leading: IconButton(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          const Padding(
                            ...
                            child: Text("Secret", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Montserrat")),
                          ),
                          Switch(
                            value: isSwitched,
                            onChanged: (value) {
                    ...
                    Center(
                        child: ElevatedButton(
                            ...
                            child: const Text("Invite Members", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Montserrat", color: Colors.black))
                        )
                    ),
                    const SizedBox(
                      height: 40,
                    ...
                    Center(
                        child: ElevatedButton(
                            ...
                            child: const Text("Delete Timeline", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, fontFamily: "Montserrat", color: Colors.black))
                        )
                    )
                  ],
                ),
