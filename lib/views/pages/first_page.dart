    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              label: "Alram",
              icon: Image.asset('assets/img/alram.png')
          ),
          BottomNavigationBarItem(
              label: "User",
              icon: Image.asset('assets/img/multi_user.png')
          )
        ],
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
            ...
            children: [
              ...
              //         children: [
              //           Text("Suggested", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: 'Montserrat'))
              //         ])
              // ),
              // Container(
              ...
              //   ),
              // ),
              // Image.asset('assets/img/background.png', width: width, fit: BoxFit.fitWidth,),
              // Image.asset('assets/img/banner.png', width: width, fit: BoxFit.fitWidth,)
            ]
        ),
      ),
